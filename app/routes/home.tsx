...
export default function Home({ loaderData }: Route.ComponentProps) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950">
      ...
      <p className="mb-8 text-emerald-200 text-lg">
        Your one-stop destination for all things gaming.
      </p>
      <NavLink
        to={`/library`}
        className="px-6 py-3 bg-emerald-600 text-slate-100 rounded-lg font-semibold shadow hover:bg-emerald-700 transition"
      >
        View Your Library
      </NavLink>
    </div>
